...
const REAL_MINING_ZONES = [
  {
    id: 'JH-01',
    name: 'Dhanbad Coal Belt — Sector A',
    description: 'Active illegal coal extraction reported by Jharkhand Mining Dept. (2023)',
  ...
  {
    id: 'JH-02',
    name: 'Ramgarh District — Iron Ore Zone',
    description: 'Unauthorized iron ore mining overlapping forest land (Saranda buffer)',
  ...
  {
    id: 'JH-04',
    name: 'West Singhbhum — Saranda Forest',
    description: 'Deforestation proxy for mining activity in Saranda Protected Forest',
